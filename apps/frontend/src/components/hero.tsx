      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center flex-wrap px-3">
        ...
        <div className="flex flex-col w-full justify-center items-start md:w-2/5 text-center md:text-left">
          <p className="capitalize tracking-wide w-full">
            Expore insights, tutorials, and stories for curious minds like yours
          </p>
          <h2 className="my-5 text-4xl font-bold leading-tight">
            Welcome to Tsukuyomi Dev Blog
          </h2>
          <p className="capitalized leading-normal text-xl">
        ...
        <div className="w-full flex justify-center text-center py-7 md:w-3/5">
          {/* <img src="/hero.png" alt="hero section"  className="w-full md:w-4/5 z-30"/> */}
          <Image
            priority
            width={500}
            height={500}
